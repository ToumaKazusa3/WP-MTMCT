...
class LoadImages:  # for inference
    ...
    def __next__(self):
        ...
        # Read image
        img00 = cv2.imread(img_path)  # BGR
        assert img00 is not None, 'Failed to load ' + img_path

        # create windows
        img0List = [img00[0:1500, 0:2000], img00[0:1500, 1000:3000], img00[0:1500, 2000:4000],
                       img00[750:2250, 0:2000], img00[750:2250, 1000:3000], img00[750:2250, 2000:4000],
                       img00[1500:3000, 0:2000], img00[1500:3000, 1000:3000], img00[1500:3000, 2000:4000]]

        imgList = []
        # img0 is not original image!!!
        for img0 in img0List:
            # Padded resize
        ...
        return img_path, img00, imgList, img0List
