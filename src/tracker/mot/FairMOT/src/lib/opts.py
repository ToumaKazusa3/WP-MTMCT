...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--exp_name_new', type=str, default='debug')
    ...
    self.parser.add_argument('--keep_res', action='store_true',
                             help='keep the original resolution'
                                  ' during validation.')
    self.parser.add_argument('--use_gps', type=bool, default=False,
                             help='use gps or not.')
    # tracking
    ...
    self.parser.add_argument('--cam_id', type=int, default=1,
                             help='camera id.')

    # add
    self.parser.add_argument('--det_filename', type=str)
    self.parser.add_argument('--reid_model_path', type=str)
