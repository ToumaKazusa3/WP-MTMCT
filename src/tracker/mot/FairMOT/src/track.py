...
from wp.utils_for_mtmct import DataProcesser
...
def track_main(opt, data_root='/data/MOT16/train', det_root=None, seqs=('MOT16-05',), exp_name='demo',
         save_images=False, save_videos=False, show_image=False, save_crop_images=False, count_dataset_info=True, generate_refine_result=False):
    ...
    for seq in seqs:
        ...
        result_filename = result_root / ('{}_update_without_gps.txt'.format(seq))
        # result_filename_refine = result_root / ('{}_update_with_gps.txt'.format(seq))
